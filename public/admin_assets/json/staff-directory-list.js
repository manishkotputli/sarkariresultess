document.addEventListener('DOMContentLoaded', function () {
    if (document.querySelector('#staff-directory-list')) {
		new DataTable('#staff-directory-list', {
				"searching": false, 
				"info": false,
					"ordering": true,
				"autoWidth": true,
			...
			"columns": [
                ...
                { "data": "name" },		
                { "render": function ( data, type, row ){
					if(row['stage'] == "0") { var class_name = "danger";var status_name ="Finance" } else if(row['stage'] == "1") { var class_name = "warning";var status_name ="Marketing" }  else if (row['stage'] == "2") { var class_name = "success";var status_name ="Design"} else { var class_name = "info";var status_name ="Support"}
