document.addEventListener('DOMContentLoaded', function () {
	...
	if (document.querySelector('#chartBar1')) {
...
if (document.querySelector('#chartBar2')) {
...
if (document.querySelector('#chartBar3')) {
...
if (document.querySelector('#chartBar4')) {
...
if (document.querySelector('#chartBar5')) {
	...
	/** STACKED BAR CHART **/
if (document.querySelector('#chartStacked1')) {
...
if (document.querySelector('#chartStacked2')) {
...
if (document.querySelector('#time-chart')) {
    var sCol = {
      chart: {
        width: '56',
        height: 70,
  ...
  if (document.querySelector('#time-chart02')) {
    var sCol = {
      chart: {
        width: '56',
        height: 70,
  ...
  if (document.querySelector('#time-chart03')) {
    var sCol = {
      chart: {
        width: '56',
        height: 70,
  ...
  if (document.querySelector('#time-chart04')) {
    var sCol = {
      chart: {
        width: '56',
        height: 70,
	...
	/* LINE CHART */
if (document.querySelector('#chartLine1')) {
	...
	/** AREA CHART **/
if (document.querySelector('#chartArea1')) {
...
if (document.querySelector('#chartDonut')) {
	...
	if (document.querySelector('#mySemiDonutChart')) {
	...
	if (document.querySelector('#deal_chart')) {
